...
public class BrushParser extends DataParser {
    ...
    public static Brush parse(UnrealPackage.ExportEntry entry, UnrealSerializerFactory serializerFactory) {
